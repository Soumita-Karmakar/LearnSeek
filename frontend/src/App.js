...
import AllTeacher from './component/teacher/AllTeacher';
...
import TeacherMyChat from "./component/teacher/TeacherMyChat";
import TeacherMyReview from "./component/teacher/TeacherMyReview";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/teachermychats" element={<TeacherMyChat />} />
          <Route path="/teacherreviews" element={<TeacherMyReview />} />
